  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: const [
          BoxShadow(color: kHistDark, offset: Offset(3, 3), blurRadius: 0)
        ],
      ),
      child: Column(
        children: [
          // Header del grupo — negro sólido
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(
                child: Text(
                  'EQUIPO',
                  style: monoStyle(
                      size: 8, color: kHistMuted, weight: FontWeight.w700),
                ),
              ),
          ...
          ...rows.asMap().entries.map((e) {
            final i   = e.key;
            final row = e.value;
            final adv = i < 2; // clasificados

            return Container(
              decoration: BoxDecoration(
                // FIX: antes era Color(0xFF10B981) sólido → ilegible en dark
                // Ahora: blanco con tinte verde muy suave
                color: adv
                    ? const Color(0xFFECFDF5) // verde menta muy claro
                    : Colors.white,
                border: const Border(
                ...
                Expanded(
                  child: Text(
                    ...
                    style: monoStyle(
                      size: 11,
                      color: kHistDark,
                      weight: adv ? FontWeight.w700 : FontWeight.normal,
                    ),
